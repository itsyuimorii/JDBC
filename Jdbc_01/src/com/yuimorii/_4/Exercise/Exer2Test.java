...
/**
 * @program: JDBC
 * @description: 问题1：向examstudent表中添加一条记录
 * @author: yuimorii
 * @create: 2022-12-22 10:27
 **/
public class Exer2Test {
    ...
    /**
     * @Description: Question 2: Check student grade information based on ID number or pass number
     * @Author: yuimorii
     */
    ...
    public void queryWithIDCardOrExamCard() {
        ...
        System.out.println("a.Pass number");
        ...
        if ("a".equalsIgnoreCase(selection)) {
            ...
            if (student != null) {
                ...
                System.out.println("The entered pass number is wrong！");
            }
            ...
            if (student != null) {
                ...
                System.out.println("The ID number entered is incorrect！");
            }
        } else {
            System.out.println("Your input was incorrect, please re-enter the program.");
